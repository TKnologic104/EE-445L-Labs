/********* main.c **************
 ...
 Description: Main program to test Lab 1 Fall 2017
...
int main(void){uint32_t i;
  ...
  while(1){
		...
		TitleScreen("Lab 1", "-NOT FUN", "Tarang", "Khandpur", "Karime", "Saad");
		Pause();
    ...
    Pause();
		...
		//Tests ST7735_XYplotInit and ST7735_XYplot
...
/*******Name: PortF_Init**********
// Description: Initializes Port F. Activates clock for Port F.
// Inputs: None
// Outputs: None
